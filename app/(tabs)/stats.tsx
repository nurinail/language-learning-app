...
export default function StatsScreen() {
  ...
  const knownPercent = total
    ? Math.round((known.length / total) * 100)
    : 0;

  const unknownPercent = total
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.row}>
        {/* 🔥 KNOWN CLICK */}
        <TouchableOpacity
          style={[styles.smallCard, styles.knownCard]}
          onPress={() => router.push("/words?type=known")}
        >
        ...
        {/* 🔥 UNKNOWN CLICK */}
        <TouchableOpacity
          style={[styles.smallCard, styles.unknownCard]}
          onPress={() => router.push("/words?type=unknown")}
        >
